  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <a class="navbar-brand" href="login.jsp"><span class="fa fa-user-circle"</span>Login</a>
      </li>
      <li class="nav-item">
          <a class="navbar-brand" href="Register_page.jsp"><span class="fa fa-user-plus"</span>Sign In</a>
      </li>
          </ul>
